...
Current authoring requires a workspace owner account. Public signup, invitations, role-management screens, approval workflows and collaborative editing are not implemented yet. Saves are manual; there is no autosave. Photographs are supported, including marks and arrows drawn onto them, captions, ordering and reuse. Non-image attachments are not.

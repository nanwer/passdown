...
Open signup is deliberately off: an account exists because somebody was invited or because the installation created the first one. Approval workflows, community contribution and collaborative editing are not implemented. Saves are manual; there is no autosave. Photographs are supported, including marks and arrows drawn onto them, captions, ordering and reuse. Non-image attachments are not. Email is not sent anywhere — invitations are links you pass on yourself.

...
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Search while typing       | Open a guide in Studio, select a step, then choose **Add from catalog**. Type part of an item name or specification.         | The dialog is titled **Choose tools and materials**. The list narrows as you type. There are no category or type filters: an item carries no permanent classification.                                   |

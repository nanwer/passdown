/**
 * A showcase library for a flat-pack furniture company.
 *
 * The invented company is Nordhavn. Real retailers' names and product names are
 * trademarks, and this repository is public — so the domain is accurate and the
 * branding is not anyone's. A reviewer reading these guides should recognise the
 * work: cam locks and dowels on the customer side, edge banding and 2K lacquer
...
export const productionTools: ShowcaseItem[] = [
  {
    ...
    manufacturer: 'Brandt Werkzeug',
    model: 'TD-5',
    partNumber: 'BW-405-005',
    defaultUnit: 'each',
  },
  {
  ...
  },
  {
    ...
    manufacturer: 'Kanthöger',
    model: 'PSB-350',
    partNumber: 'KH-600-350',
    defaultUnit: 'each',
  },
  {
...
export const productionMaterials: ShowcaseItem[] = [
  {
    ...
    description: 'The standard carcass board for this range.',
    manufacturer: 'Sørland Board',
    model: 'MFC-18-W',
    partNumber: 'SB-700-018',
    defaultUnit: 'each',
  },
  {
...
export const publicGuides: ShowcaseGuide[] = [
  {
    ...
    thing: 'Wardrobe',
    summary:
      'The order every Nordhavn wardrobe goes together in, whatever its width or number of doors.',
    difficulty: 'moderate',
    minutes: 90,
    needs: [
